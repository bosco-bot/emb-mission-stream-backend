...
class MediaSyncOptimized
{
    private string $azuracastPath;
    
    public function __construct()
    {
        $this->azuracastPath = '/var/lib/docker/volumes/azuracast_station_data/_data/radio_emb_mission/media/';
    }

    public function syncAllMedia(): void
    {
        ...
        foreach ($mediaFiles as $index => $mediaFile) {
            ...
            $targetPath = $this->azuracastPath . $mediaFile->filename;
