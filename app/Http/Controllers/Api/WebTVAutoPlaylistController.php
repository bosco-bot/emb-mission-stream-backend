...
class WebTVAutoPlaylistController extends Controller
{
    ...
    public function checkLiveStatusOnly(): JsonResponse
    {
        try {
            $status = $this->autoPlaylistService->getAutoPlaylistStatus();
    ...
    public function forceRefreshStatus(): JsonResponse
    {
        try {
            $status = $this->autoPlaylistService->getAutoPlaylistStatus();
            return response()->json(['success' => true, 'data' => $status]);
    ...
    public function cleanupGhostConnections(): JsonResponse
    {
    ...
    {
        return response()->json(['success' => true, 'message' => 'Cache rafraîchi']);
    }
}
