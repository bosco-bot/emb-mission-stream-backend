...
(function(){
    ...
    var serviceToSystemd = {'nginx':'nginx','php-fpm':'php8.1-fpm','mysql':'mysql','antmedia':'antmedia','ffmpeg-live-transcode':'ffmpeg-live-transcode','supervisor':'supervisor','cron':'cron','docker':'docker','queue-worker':'laravel-queue-worker','unified-stream':'unified-stream','reverb':'laravel-reverb'};
